...
final class Separator {
     ...
     * и выдаётся в качестве результата. Если тип содержимого был неверно определен как число, то обработка строк
     * не прерывается, а ошибочно классифицированная строка считается простой строкой.
     *
