...
final class ContentTypeClassifier {
     ...
     * Если строка или подстрока пустая (beginIndex больше последнего индекса string), то её нельзя конвертировать
     * в число. У целого числа первый символ, кроме цифры, может быть знак, а остальные символы должны быть цифрами.
