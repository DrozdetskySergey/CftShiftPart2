...
public final class Arguments {
    ...
    /**
     * В массиве строк выбрасывают null и пустые строки. Убирает пробелы в начале и конце строк. Считается, что
     * оставшиеся строки это аргументы: {@linkplain Option опции}, их аргументы и операнды (не опции).
