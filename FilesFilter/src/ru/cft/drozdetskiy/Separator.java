...
final class Separator {
     ...
     * У целого числа первый символ кроме цифры может быть '+' или '-', остальные символы должны быть цифрами.
    ...
    /**
     * ВНИМАНИЕ: содержимое проверяемой строки должно быть типа LONG (целое число)!
    ...
    /**
     * Проверяет тип содержимого строки это LONG (целое число) или нет.
     * Т.е. первый символ кроме цифры может быть '+' или '-', остальные символы могут быть только цифрами.
     *
     * @param string проверяемая строка.
     * @return true если содержимое строки типа LONG (целое число).
     */
