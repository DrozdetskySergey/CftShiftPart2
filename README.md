...
последняя. При отсутствии какой-либо из них, будет действовать **-s** (по умолчанию краткая статистика).\
...
и называется масштабом (scale). Если масштаб выходит за данный диапазон, то такие данные считаются
строкой и записываются в файл со строками.\
...
Сторонние библиотеки: slf4j-api-2.0.13, log4j-slf4j2-impl-2.25.0, log4j-api-2.25.0, log4j-core-2.25.4\
### Запуск
!!! *Должна быть установлена Java версии 17 либо выше.*\
Запускается с помощью команды: **java -jar FilesFilter.jar**
